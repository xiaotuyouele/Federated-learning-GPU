...
def args_parser():
    ...
    # other arguments
    parser.add_argument('--dataset', type=str, default='synthetic', help="synthetic/mnist/cifar")  # 保留一个 dataset
    ...
    parser.add_argument('--input_size', type=int, default=5000, help='high-dim vector size')
